...
#   7/6/2022 - defaults set up for LaDOTD
...
#   because  I didn't have permission to update the default package location for Python on the DOTD computer.
...
try:
    ...
    import arcgis  #https://community.esri.com/t5/python-questions/importerror-dll-load-failed-the-specified-module/td-p/141622
...
class AppTool(object):
    ...
    def getParameterInfo(self):
        ...
        params = [TemplateSpreadsheet, outdir, ImportPortalDetails, GetPortalDetails,portval]
        return params
...
class ScrapeRestEndpoints(object):
    ...
    def getParameterInfo(self):
        ...
        inputURL.value = 'https://arcadis.com/portal'
